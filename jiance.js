    ...
    await inner_check()
      .then((code) => {
        if (code === 'Not Available') {
          ...
          youtube_check_result += " +`${getFlagEmoji(region)} ` + region.toUpperCase()
        }
      })
      .catch((error) => {
  ...
  async function check_netflix() {
    ...
    await inner_check(81215567)
      .then((code) => {
        ...
        netflix_check_result+= " +`${getFlagEmoji(region)} ` + region.toUpperCase()
      ...
      .then((code) => {
        ...
        netflix_check_result += '自制' +  " +`${getFlagEmoji(region)} ` + region.toUpperCase()
        return Promise.reject('BreakSignal')
      })
      .catch((error) => {
